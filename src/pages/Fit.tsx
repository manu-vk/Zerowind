...
import motionsvgg from "../assets/images/motionn.webp";
...
function Fit() {
    ...
    const firstOpacity = useTransform(firstProgress, [0, 1], [0.3, 1]);
    ...
    return (
            ...
            <section className="relative w-full mt-[-30px] min-h-screen overflow-hidden bg-[#232323]">
             ...
             text-[white] font-bold"
                    ...
                    <motion.img
                        ...
                        className="absolute left-1/2 top-1/2 w-[300px] -translate-x-1/2 -translate-y-1/2 brightness-150"
                    />
                    ...
                    <motion.img
                        ...
                        className="fixed left-[-40px] top-1/2 -translate-y-1/2 w-[200px] z-20 brightness-50"
                        animate={{
                            rotate: -90, 
                        }}
                    />
            ...
            <section className="bg-[#232323] py-24">
                <div className="mx-auto max-w-[1100px] px-8">
                    ...
                    >
                        ...
                        breathable, fully windproof and waterproof outdoor sportswear garments
        ...
        "
                >
                    The construction of these fabrics and their totally PFAS-free hydrophilic
                    membrane create garments that combine high performance with extraordinary
                    comfort that enhances the technicality of the material.
            ...
            <section className="relative bg-[#232323] pt-10 pb-20">

                <div className="absolute top-25 left-1/2 -translate-x-1/2 w-full max-w-[400px]  overflow-hidden z-20">
                    <motion.div
            ...
            <div className="bg-[#232323] w-full ">
                <section className=" relative max-w-[1200px]  mx-auto px-8 pt-16"
