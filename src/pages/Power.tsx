...
import bravee from "../assets/images/bravee.webp";
...
function Power() {
  ...
  const navigate = useNavigate();
        ...
        <>
            ...
            <section className="bg-[#232323] py-24">
                <div className="mx-auto max-w-[1100px] px-8">
                    ...
                    >
                        Wind protection is the goal behind ZeroWind's POWER fabric line, to which we have combined excellent
    ...
    <div className="pt-[-10] flex flex-col gap-10">
                ...
                <section className=" relative max-w-[1200px] mx-auto px-8"
